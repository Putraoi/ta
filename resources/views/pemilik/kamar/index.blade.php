                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <a href="{{url('room', $item->slug)}}" class="btn btn-info btn-sm w-75 h-25">Show</a>
                        <a href="{{route('kamar.edit', $item->slug)}}" class="btn btn-warning btn-sm w-75 mt-1 h-25">Edit</a>
                        <a data-id-kamar="{{$item->id}}" id="isAktifKamar" class="btn btn-danger btn-sm w-75 mt-1 h-25">{{$item->is_active == 0 ? 'Aktif' : 'Stop'}}</a>
                        @if ($item->status == 0)
                            <span class="btn btn-primary btn-sm text-white w-75 mt-1 h-25">Review</span>
                        @endif
                      </td>
                    </tr>
                    @endforeach
